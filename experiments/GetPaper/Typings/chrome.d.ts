...
declare module chrome.webRequest {
    ...
    interface WebRequestCompletedEvent extends chrome.events.Event { 
        addListener(callback: (details: OnCompletedDetails) => void, filter:RequestFilter, extraInfoSpec?:string[]): void;
    }

    interface WebRequestHeadersReceivedEvent extends chrome.events.Event { 
        addListener(callback: (details: OnHeadersReceivedDetails) => void, filter:RequestFilter, extraInfoSpec?:string[]): void;
    }

    interface WebRequestBeforeRedirectEvent extends chrome.events.Event { 
        addListener(callback: (details: OnBeforeRedirectDetails) => void, filter:RequestFilter, extraInfoSpec?:string[]): void;
    }

    interface WebRequestAuthRequiredEvent extends chrome.events.Event { 
        addListener(callback: (details: OnAuthRequiredDetails, callback?: (response: BlockingResponse) => void, filter:RequestFilter, extraInfoSpec?:string[]) => void): void;
    }

    interface WebRequestBeforeSendHeadersEvent extends chrome.events.Event { 
        addListener(callback: (details: OnBeforeSendHeadersDetails) => void, filter:RequestFilter, extraInfoSpec?:string[]): void;
    }

    interface WebRequestErrorOccurredEvent extends chrome.events.Event { 
        addListener(callback: (details: OnErrorOccurredDetails) => void, filter:RequestFilter, extraInfoSpec?:string[]): void;
    }

    interface WebRequestResponseStartedEvent extends chrome.events.Event { 
        addListener(callback: (details: OnResponseStartedDetails) => void, filter:RequestFilter, extraInfoSpec?:string[]): void;
    }

    interface WebRequestSendHeadersEvent extends chrome.events.Event { 
        addListener(callback: (details: OnSendHeadersDetails) => void, filter:RequestFilter, extraInfoSpec?:string[]): void;
    }

    interface WebRequestBeforeRequestEvent extends chrome.events.Event { 
        addListener(callback: (details: OnBeforeRequestDetails) => void, filter:RequestFilter, extraInfoSpec?:string[]): void;
    }
